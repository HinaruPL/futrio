...
Warto odmierzaÄ‡ porcje, kontrolowac przysmaki i regularnie sprawdzac sylwetke psa. NagĹ‚e zmiany apetytu, masy ciala lub trawienia powinny byc omowione z lekarzem.'),
...
WITH batch_recognitions(slug, organization_code, organization_name, recognized, recognition_status, note, source_url, verified_at) AS (
  VALUES
  ('terrier-brazylijski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Brazilian Terrier; numer FCI: 341.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('niemiecki-terier-mysliwski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: German Hunting Terrier; numer FCI: 103.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('fox-terrier-krotkowlosy', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Fox Terrier (Smooth); numer FCI: 12.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('manchester-terrier', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Manchester Terrier; numer FCI: 71.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('glen-of-imaal-terrier', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Irish Glen of Imaal Terrier; numer FCI: 302.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('irish-soft-coated-wheaten-terrier', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Irish Soft Coated Wheaten Terrier; numer FCI: 40.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('terier-japonski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Japanese Terrier; numer FCI: 259.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('miniaturowy-bull-terrier', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Miniature Bull Terrier; numer FCI: 359.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('australian-silky-terrier', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Australian Silky Terrier; numer FCI: 236.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('english-toy-terrier', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: English Toy Terrier (Black & Tan); numer FCI: 13.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('bolonczyk', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Bolognese; numer FCI: 196.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('lwi-piesek', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Little Lion Dog; numer FCI: 233.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('griffon-belge', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Griffon Belge; numer FCI: 81.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('griffon-bruxellois', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Griffon Bruxellois; numer FCI: 80.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('petit-brabancon', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Petit Brabancon; numer FCI: 82.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('grzywacz-chinski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Chinese Crested Dog; numer FCI: 288.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('spaniel-tybetanski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Tibetan Spaniel; numer FCI: 231.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('terier-tybetanski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Tibetan Terrier; numer FCI: 209.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('king-charles-spaniel', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: King Charles Spaniel; numer FCI: 128.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('chin-japonski', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Japanese Chin; numer FCI: 206.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('russkiy-toy', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Russian Toy; numer FCI: 352.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('kromfohrlander', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Kromfohrlander; numer FCI: 192.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('chesapeake-bay-retriever', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Chesapeake Bay Retriever; numer FCI: 263.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('kooikerhondje', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Nederlandse Kooikerhondje; numer FCI: 314.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24'),
  ('barbet', 'FCI', 'FĂ©dĂ©ration Cynologique Internationale', 1, 'recognized', 'Zweryfikowano w oficjalnej nomenklaturze FCI. Nazwa w zrodle: Barbet; numer FCI: 105.', 'https://www.fci.be/en/Nomenclature/', '2026-06-24')
),
orgs(organization_code, organization_name) AS (
  VALUES
  ('AKC', 'American Kennel Club'),
